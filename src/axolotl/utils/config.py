...
def normalize_config(cfg):
    ...
    cfg.dataset_processes = cfg.dataset_processes or min(16, int(os.cpu_count()*0.8))
...
def validate_config(cfg):
    ...
    if cfg.val_set_size == 0 and (cfg.eval_steps or cfg.evaluation_strategy) and (not cfg.eval_datasets):
        raise ValueError(
